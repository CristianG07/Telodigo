...
export const Hero = () => {
  return (
    <section className='bg-hero bg-bottom bg-cover text-white'>
      <div className='container_setions pt-20 pb-14 lg:pb-28 flex flex-col-reverse md:flex-row lg:justify-between items-center gap-5'>
        <div className='text-center md:text-start lg:mt-32 flex-shrink-0'>
          <h2 className='text-4xl md:text-5xl lg:text-6xl lg:leading-[4.5rem] font-bold'>
            HOSTALES POR <br /> HORAS
          </h2>
          <p className='text-xl mb-7 lg:mb-5'>Más cercanos a ti...</p>
          <Link className='btn_primary px-7 py-3' to='/download-app'>
            DOWNLOAD
          </Link>
        </div>
